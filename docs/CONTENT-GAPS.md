...
| G3 | **Legal pages.** No privacy or terms text. | `/privacy`, `/terms` (Task 18 stubs) | Not generated by Task 5; Task 18 ships `PLACEHOLDER`-marked stubs. `content.checks.ts` already whitelists a future `legal` module for `PLACEHOLDER`. | **Client:** supply privacy policy and terms, or name the jurisdiction and counsel who will. |
