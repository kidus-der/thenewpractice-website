...
| **Travelling glow**            | One radial gradient in `--c-canopy` at 12–20%, bleeding `--s-6` past the row each side (the gutter where a two-column list has no more room), `x`/`y` as a transform over `--d-base`; a brass tick in the left margin; driven by pointer **and** focus. One element, not one per row: `src/sections/RowGlow.tsx`, owned by the list that knows its active row.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | T6 index lists, T1 §3 conditions          |
